  ...
  return (
    <>
      ...
      <div className="mode-modal">
        ...
        <p style={{ color: 'var(--text-secondary)', marginBottom: '22px', fontSize: '0.93rem' }}>
        ...
        <div className="mode-options">
          {modeOptions.map((opt) => (
            ...
            >
              <div style={{ fontSize: '2.4rem', marginBottom: '10px' }}>{opt.icon}</div>
              <h4 style={{ marginBottom: '6px', fontSize: '1.05rem' }}>{opt.name}</h4>
        ...
        <button onClick={closeModal} className="btn-primary" style={{ width: '100%', marginTop: '14px' }}>
